        ...
        <div className="hero__layout">
          ...
          >
            ...
            <h1 className="hero__title">
              Full-stack developer building software for real business
              operations.
            </h1>
            <p className="hero__copy">
              I turn complex business processes into clean software through
              custom APIs, web platforms, automation, analytics, and practical
              AI integration.
            </p>
          ...
          >
            ...
            <div className="hero__metrics">
              {metrics
                .filter((metric) => metric.label !== "added revenue impact")
                .map((metric) => (
